  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthBloc, AuthState>(
      ...
      child: Scaffold(
        ...
        body: BlocSelector<StudentBloc, StudentState, bool>(
          ...
          builder: (context, isLoading) {
            ...
            return BlocSelector<StudentBloc, StudentState, StudentEntity?>(
              selector: (state) =>
                  state is StudentDashboardLoadSuccess ? state.student : null,
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      BlocSelector<StudentBloc, StudentState,
                          StudentTimeStats?>(
                        selector: (state) =>
                            state is StudentDashboardLoadSuccess
                                ? state.timeStats
                                : null,
                        builder: (context, timeStats) {
                          return Card(
                            child: Padding(
                              padding: const EdgeInsets.all(16),
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                      'Esta Semana: ${timeStats?.hoursThisWeek ?? 0.0} horas'),
                                  Text(
                                      'Este Mês: ${timeStats?.hoursThisMonth ?? 0.0} horas'),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                        'Tipo: ${contracts.first.contractType}'),
                                    Text(
                                        'Início: ${_formatDatePtBr(contracts.first.startDate)}'),
                                    Text(
                                        'Fim: ${_formatDatePtBr(contracts.first.endDate)}'),
                                    if (contracts.first.description != null)
                                      Text(
                                          'Descrição: ${contracts.first.description}'),
                                  ],
                                ),
                              ),
                            );
